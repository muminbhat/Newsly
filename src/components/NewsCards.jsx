...
const NewsCards = () => {
  ...
  const api = 'https://gnews.io/api/v4/search?q=example&lang=en&country=us&max=10&apikey=fbaff7028c68e0c03354cefb43a4c9cb';
  ...
  useEffect(() => {
    ...
    fetchData();
  }, []); // Include 'page' in the dependency array
                  ...
                  <a href={"article.provider[0].url"}>
                    <div className="flex-shrink-0 relative w-[20]  overflow-hidden w-[20] h-[20px] before:absolute before:inset-x-0 before:w-full before:h-full">
                      <img
                        ...
                        src={"article.provider[0].image.url"}
                        alt="Image Description"
                      />
                    </div>
                  </a>
